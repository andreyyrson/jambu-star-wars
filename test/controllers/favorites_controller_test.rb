...
class FavoritesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favorite" do
    assert_difference("Favorite.count") do
      post favorites_url, params: { favorite: { favoritable_id: @favorite.favoritable_id, favoritable_type: @favorite.favoritable_type } }
    end
  ...
  test "should update favorite" do
    patch favorite_url(@favorite), params: { favorite: { favoritable_id: @favorite.favoritable_id, favoritable_type: @favorite.favoritable_type } }
